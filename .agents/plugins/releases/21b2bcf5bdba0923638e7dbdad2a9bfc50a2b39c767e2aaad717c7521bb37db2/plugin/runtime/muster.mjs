...
import { lstat as lstat5, mkdir as mkdir6, open as open4, readFile as readFile9, readdir as readdir9, rename as rename4, rm, writeFile as writeFile4 } from "node:fs/promises";
