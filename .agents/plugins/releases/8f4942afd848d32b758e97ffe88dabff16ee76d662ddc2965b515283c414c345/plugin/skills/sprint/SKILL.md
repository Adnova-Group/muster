...
Use this skill when the request needs to legacy alias of muster-go-backlog. Treat the user's remaining prompt as the outcome or backlog reference.
...
2. Read `${PLUGIN_ROOT}/commands/sprint.md` for the authoritative workflow and preserve its approval, isolation, escalation, and receipt gates.
