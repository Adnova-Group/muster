...
Heads-up for the user (say this once, one line): $muster-go-backlog is now $muster-go-backlog — same behavior, clearer name; this alias keeps working.
...
Read ${PLUGIN_ROOT}/commands/go-backlog.md (resolve relative to this file's own directory / the plugin root) and execute its instructions exactly, with the arguments given to this command.
