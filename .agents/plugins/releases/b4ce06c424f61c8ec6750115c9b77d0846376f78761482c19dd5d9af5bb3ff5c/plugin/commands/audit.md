...
<!-- muster-codex-audit-contract {"dimensions":["architecture","tech-debt","coverage","simplification","readability","security"],"maximumBatchWidth":3,"sequence":["capacity-receipt","dispatch-batches","dimension-receipts","consolidate"],"consolidationRequires":["architecture","tech-debt","coverage","simplification","readability","security"]} -->
