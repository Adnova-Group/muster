...
| Gradient partner | `#41b3ff` | `#41b3ff` | Mark asset (informative graphic) and hero-image glow (decorative) |
...
active/gradient-partner gradient, which stays confined to the mark asset (an informative graphic
with its own accessible name, not essential text) and the blurred, decorative hero-image glow.
Focus indicators use the primary color plus sufficient offset to remain visible in both themes.
