...
if (probeRequested) {
  ...
  cleanEnv.MUSTER_CHATGPT_WORK_PROBE_IDENTITY = process.env.MUSTER_CHATGPT_WORK_PROBE_IDENTITY;
  cleanEnv.MUSTER_CHATGPT_WORK_PROBE_SERVER_INSTANCE_ID = process.env.MUSTER_CHATGPT_WORK_PROBE_SERVER_INSTANCE_ID;
  cleanEnv.MUSTER_CHATGPT_WORK_PROBE_PARENT_ID = process.env.MUSTER_CHATGPT_WORK_PROBE_PARENT_ID;
}
