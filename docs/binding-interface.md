...
dispatch time: `plugin/commands` (the eleven modes plus the three legacy aliases,
...
vendored `wsh-*.md` personas), and `plugin/output-styles/muster.md` -- thirty-two files.
