...
- `git patch-id` cross-checks (old checkout vs. current `af6c34e` ancestry):
  ...
  - `7191001` vs `fa76a27` → differ (both are the same class of stray-fixture
    cleanup; content differs only in the tmp-dir random suffix)
