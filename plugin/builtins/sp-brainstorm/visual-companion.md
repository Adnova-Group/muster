<!-- prompt-lint-disable ANTH-ROLE-001, ANTH-FMT-001, ANTH-POS-001, GUARD-IDK-001, GUARD-CITE-002, ANTH-XML-001, GUARD-SEP-003: Pinned upstream supporting asset loaded inside its parent skill; the parent supplies role, output, evidence, and input boundaries. -->
...
```jsonl
{"type":"click","choice":"a","text":"Option A - Simple Layout","id":null}
{"type":"click","choice":"c","text":"Option C - Complex Grid","id":null}
{"type":"click","choice":"b","text":"Option B - Hybrid","id":null}
```
...
- **Use real content when it matters** — download approved images into the session content directory and reference them as `/files/<name>`; remote image origins are intentionally blocked. Placeholder content obscures design issues.
