...
for (const marker of ["Quota-bounded dimension sweep", "three nonredundant read-only briefs", "system quality", "Respect `agents.max_concurrent_threads_per_session`", "codex-audit-provider <request.json>", "CODEX_AUDIT_NO_COMPATIBLE_PROVIDER", "dispatch ONLY its returned packet"]) {
