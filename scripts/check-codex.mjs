...
const modes = ["muster", "muster-plan", "muster-go", "muster-plan-backlog", "muster-go-backlog", "muster-diagnose", "muster-audit", "muster-security", "muster-runner", "muster-capture", "muster-init", "muster-design"];
...
if (watchSurfaces.length !== 17) fail(`agent watch coverage drifted to ${watchSurfaces.length} surfaces instead of 17`);
