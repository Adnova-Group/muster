...
function rpc(requests, { timeout = 30_000, serverPath, cwd } = {}) {
  return new Promise((resolve, reject) => {
    const srv = spawn("node", [serverPath || path.join(rootDir, "cowork", "mcp-server.mjs")], { cwd: cwd || rootDir, stdio: ["pipe", "pipe", "inherit"] });
