...
features:
  ...
  - icon: 🚦
    title: Five modes
    details: Run plans and shows. Autopilot runs the full lifecycle hands-off. Diagnose fixes one bug failure-first. Audit sweeps the whole codebase. Sprint runs a whole backlog in one sitting.
  - icon: 🔒
