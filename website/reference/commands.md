...
| `security <info\|route\|review\|audit> ...` | Inspect the immutable upstream pin, decide whether scope/diff risk warrants a scan, or run official Codex Security against a diff, working tree, repository, or paths. Findings retain severity and evidence; dependency/version/coverage/runtime failures fail loudly. |
